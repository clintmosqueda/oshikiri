...
add_image_size( 'featured-product', 656, 732, true );
add_image_size( 'featured-news', 2076, 1140, true );
add_image_size( 'featured-case', 958, 656, true );
add_image_size( 'featured-employee', 800, 800, true );
add_image_size( 'card-cases', 620, 400, true );
