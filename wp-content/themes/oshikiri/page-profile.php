...
$contents = [
  ...
  array( 'label' => '社名', 'description' => '株式会社 オシキリ'),
  array( 'label' => '所在地', 'description' => '<div>[ 本社 ]<br/>〒252-0811<br class="show-sp"/> 神奈川県藤沢市桐原町4番地 <br class="show-sp"/><a href="">GoogleMap</a></div>
  <div>[工場 ]<br/><span>湘南（藤沢）</span><span>山形（東根）</span></div>
  <div>[ 営業所 ]<br/><span>東京</span><span>大阪</span><span>名古屋</span><span>福岡</span></div>
  <div>[ 販売会社 ]<br/>オシキリ北日本（札幌・仙台）<br class="show-sp"/><a href="">事業所一覧</a></div>
  '),
